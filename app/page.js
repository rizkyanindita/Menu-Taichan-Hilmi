...
export default function Home() {
    return (
        <div className="flex flex-1 flex-col items-center justify-center gap-4 sm:gap-6 p-4 text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 max-w-[280px] sm:max-w-md mx-auto leading-relaxed">
                The modern way to order food directly from your phone. Scan code, view menu, and order.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href="/menu/demo-cafe" className="px-6 py-3 bg-white border border-gray-200 text-gray-900 rounded-xl font-medium hover:bg-gray-50 transition-colors shadow-sm">View Demo Menu</Link>
