    ...
    return (
        <div className="flex flex-1 flex-col items-center justify-center gap-4 sm:gap-6 p-4 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href={`/menu/${CAFE_ID}`} className="px-6 py-3 bg-white border border-gray-200 text-gray-900 rounded-xl font-medium hover:bg-gray-50 transition-colors shadow-sm">View Menu</Link>
