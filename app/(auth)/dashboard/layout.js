    ...
    useEffect(() => {
        ...
        if (savedUser) {
            try {
                ...
                if (user.role === "owner") {
                    setUserName(process.env.NEXT_PUBLIC_OWNERNAME);
                ...
                <nav className="bg-white/95 dark:bg-[#141414]/95 backdrop-blur-sm border-b-2 border-gray-100 dark:border-white/10 px-6 py-4 sticky top-0 z-50 shadow-sm">
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* User Info */}
                            <div className="hidden sm:flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-500/10 dark:to-indigo-500/10 rounded-xl border border-blue-100 dark:border-blue-500/20">
                                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
                                    <span className="text-white text-sm font-bold">👤</span>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Selamat datang!</p>
